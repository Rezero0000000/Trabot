    ...
    return (
       ...
       <section className="font-poppins">
        ...
        <div className="py-6  px-5 xs:absolute sm:px-9 sm:py-8 xs:px-6 lg:px-20 xl:px-24">
          ...
          <p className=" w-[17.4rem] sm:w-[20rem] mt-4 text-[#9E9E9E] xs:text-[#dddcdcef] lg:text-[13px] lg:w-[23rem] mb-6 text-sm xs:text-[12px] font-thin">Discover the most beautiful place in the world you've never been with us</p>
